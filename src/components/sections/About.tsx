  ...
  return (
    <article className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <section className="text-muted-foreground leading-relaxed space-y-4">
        <p>
          I am a  Full Stack Software Engineer currently pursuing my B.Tech in Computer Science and Engineering at Graphic Era Hill University. I specialize in building robust, scalable systems and performant APIs.
        </p>
        <p>
